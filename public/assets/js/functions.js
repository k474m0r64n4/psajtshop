...
(function($) {
    ...
    var $portfolioFilter2 = $(".portfolio-filter2"),
        portfolioLength2 = $portfolioFilter2.length,
        protfolioFinder2 = $portfolioFilter2.find("a"),
        $portfolioAll2 = $("#portfolio-all");

    // init Isotope For Portfolio
    protfolioFinder2.on("click", function(e) {
        e.preventDefault();
        $portfolioFilter2.find("a.active-filter").removeClass("active-filter");
        $(this).addClass("active-filter");
    });
    if (portfolioLength2 > 0) {
        $portfolioAll2.imagesLoaded().progress(function() {
            $portfolioAll2.isotope({
                filter: "*",
                animationOptions: {
                    duration: 750,
    ...
    var twitterFeed = $('#twitter-feed'),
        twitterID = '1095095489031294976'; // Your Twitter Widget Id Here
